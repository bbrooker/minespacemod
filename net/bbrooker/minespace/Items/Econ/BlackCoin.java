...
public class BlackCoin extends Item {
	
	public BlackCoin(int id) {
		super(id);
		setMaxStackSize(1024);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("BlackCoin");
		setTextureName("minespace:BlackCoin");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[BC] Use for exchange item");
		}
