...
public class BlasterCore extends Item {
	
	public BlasterCore(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("BlasterCore");
		setTextureName("minespace:BlasterCore");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[AMMO] Blaster Ammo"); //EDIT HERE
		}
