...
public class AirLicense extends Item {
	
	public AirLicense(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("AirLicense");
		setTextureName("minespace:AirLicense");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[License] Drivable Aircraft"); 
		}
