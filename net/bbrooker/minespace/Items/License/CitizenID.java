...
public class CitizenID extends Item {
	
	public CitizenID(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("CitizenID");
		setTextureName("minespace:CitizenID");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[ID] Identify Player"); //EDIT HERE
		}
