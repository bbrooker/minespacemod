...
public class SpeederLicense extends Item {
	
	public SpeederLicense(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("SpeederLicense");
		setTextureName("minespace:SpeederLicense");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[License] Drivable Speeder bike"); 
		}
