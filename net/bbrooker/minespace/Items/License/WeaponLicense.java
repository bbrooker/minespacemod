...
public class WeaponLicense extends Item {
	
	public WeaponLicense(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("WeaponLicense");
		setTextureName("minespace:WeaponLicense");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[License] Can Carry Small arms or Weapon"); 
		}
