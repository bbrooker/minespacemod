...
public class WhiteCrystal extends Item {
	
	public WhiteCrystal(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("WhiteCrystal");
		setTextureName("minespace:WhiteCrystal");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[LEGENDARY]Lightside crystal transform");
		}
