...
public class GreenCrystal extends Item {
	
	public GreenCrystal(int id) {
		super(id);
		setMaxStackSize(1);
		setCreativeTab(CreativeTabs.tabMaterials);
		setUnlocalizedName("GreenCrystal");
		setTextureName("minespace:GreenCrystal");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean is)
		{
		list.add("[RARE]Add Green Shade to Lightsaber");
		}
